...
const GameSessionSchema = new mongoose.Schema({ user_id: String, game_id: String, subscription_id: String, started_at: Date, ended_at: Date, duration_seconds: Number, is_trial: Boolean, status: String, connection_info: Object }, opts);
